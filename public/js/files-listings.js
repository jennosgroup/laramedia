...
/***/ "./resources/js/files-listings.js":
/*!****************************************!*\
  !*** ./resources/js/files-listings.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function FilesListings() {
   ...
   * @var obj
   */
  this.uploader = new _files_uploader__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  this.showFilePreview = function (media, prepend) {
    ...
    template.querySelector('.laramedia-files-item-container').addEventListener('click', function (event) {
      ...
      var editor = new _file_editor__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/******/ 	__webpack_require__.O(undefined, ["public/css/laramedia"], () => (__webpack_require__("./resources/js/files-listings.js")))
